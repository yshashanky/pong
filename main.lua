...
-- the "Class" library we're using will allow us to represent anything in our game as code
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        -- then altering the dy based on the position at which it collided, then playing a sound effect
        ...
        -- if we reach the left or right edge of the screen, go back to serve and update the score and serving player
        if ball.x < 0 then
            servingPlayer = 1
